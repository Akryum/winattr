...
const describeUnixOnly = helpers.isWindows === false ? describe : describe.skip
const describeWindowsOnly = helpers.isWindows === true ? describe : describe.skip
...
describeUnixOnly('Unix', function () {
...
describeWindowsOnly('Windows', function () {
